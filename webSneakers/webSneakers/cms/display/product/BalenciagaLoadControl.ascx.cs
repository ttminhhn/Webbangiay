...
{
    public partial class BalenciagaLoadControl : System.Web.UI.UserControl
    {
        string typePro = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            typePro = Request.QueryString["product"];
            if (!IsPostBack)
            {
                loadSanPham();
            }
        ...
        private void loadSanPham()
        {
            ...
            tb = AppCode.Database.SanPham.infoSPByHang(typePro);
            string linkSp = "";
